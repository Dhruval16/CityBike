...
lat_low <- c(40.75702193, 40.77551144, 40.69364664,  40.7079052)
long_low <- c(-73.95461027,  -74.0005498, -74.03936774, -73.97592545)
...
final <- function(month,latitude,longitude,tripdata){
  ...
  ####
  write.csv(regional_station_data,paste0("low-",month))
}
