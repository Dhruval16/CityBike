...
lat_low <- c(40.78935494, 40.80811789, 40.75702193, 40.77551144)
long_low <- c(-73.92825555, -73.97766083, -73.95461027,  -74.0005498)
...
final <- function(month,latitude,longitude,tripdata){
  ...
  ####
  write.csv(regional_station_data,paste0("mid-",month))
}
